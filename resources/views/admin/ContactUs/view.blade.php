                                                ...
                                                <table id="example5" class="display table dataTable no-footer"
                                                    ...
                                                    <thead>
                                                        <tr style="background-color: #F0F4F9;">
                                                            <x-admin.table th1='#'
                                                                th2="{{ TranslationHelper::translate('firstname') }}"
                                                                th3="{{ TranslationHelper::translate('lastname') }}"
                                                                th4="{{ TranslationHelper::translate('email') }}"
                                                                th5="{{ TranslationHelper::translate('message') }}"
                                                                th6="{{ TranslationHelper::translate('Created at') }}"
                                                                th7="{{ TranslationHelper::translate('processes') }}">
                                                            </x-admin.table>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
