                        ...
                        <form method="post" action="{{$action}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.state :foreach="App\Models\StaticConst::GENDER" :model="$user" name="gender"></x-admin.form.state>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <x-admin.form.state :foreach="App\Models\StaticConst::STATUS" :model="$user" name="status"></x-admin.form.state>
